...
int main(int argc, char *argv[])
{
    ...
    int key[16] = {0x74, 0x65, 0x73, 0x74, 0x20, 0x66, 0x75, 0x6E, 0x63, 0x74, 0x69, 0x64, 0x6E,
                   0x61, 0x6C, 0x69};
...
//
//    for (byte_pos = 0; byte_pos < 4; byte_pos++) {
//        temp[byte_pos] ^= aes_key_176[byte_pos]; // Bitwise XOR with 16bytes before
...
//    }
    ...
    for (expanded_pos = 0; expanded_pos < 10; expanded_pos++)
    {
        ...
        for (byte_pos = 0; byte_pos < 4; byte_pos++)
        {
            temp[byte_pos] ^= aes_key_176[byte_pos + (16 * expanded_pos)]; // Bitwise XOR with 16bytes before
        ...
        for (sub_pos = 0; sub_pos < 3; sub_pos++)
        {
            for (byte_pos = 0; byte_pos < 4; byte_pos++)
            {
                temp[byte_pos] ^= aes_key_176[byte_pos + 4 + (16 * expanded_pos) + (4 * sub_pos)]; // Bitwise XOR with 16bytes before
...
//    }
    ...
    for (expanded_pos = 0; expanded_pos < 8; expanded_pos++)
    {
        ...
        for (byte_pos = 0; byte_pos < 4; byte_pos++)
        {
            temp[byte_pos] ^= temp_key[byte_pos + (24 * expanded_pos)]; // Bitwise XOR with 24bytes before
        ...
        for (sub_pos = 0; sub_pos < 5; sub_pos++)
        {
            for (byte_pos = 0; byte_pos < 4; byte_pos++)
            {
                temp[byte_pos] ^= temp_key[byte_pos + 4 + (24 * expanded_pos) + (4 * sub_pos)]; // Bitwise XOR with 16bytes before
...
//    }
    ...
    for (expanded_pos = 0; expanded_pos < 7; expanded_pos++)
    {
        ...
        for (byte_pos = 0; byte_pos < 4; byte_pos++)
        {
            temp[byte_pos] ^= temp_key[byte_pos + (32 * expanded_pos)]; // Bitwise XOR with 24bytes before
        ...
        for (sub_pos = 0; sub_pos < 7; sub_pos++)
        {
            for (byte_pos = 0; byte_pos < 4; byte_pos++)
            {
                temp[byte_pos] ^= temp_key[byte_pos + 4 + (32 * expanded_pos) + (4 * sub_pos)]; // Bitwise XOR with 16bytes before
